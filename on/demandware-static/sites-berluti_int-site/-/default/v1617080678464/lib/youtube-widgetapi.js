...
(function() {
    ...
    var H = "StopIteration" in k ? k.StopIteration : {
    ...
    v(qb, P);
    var rb = 0,
        sb = m("yt.dom.dom.getNextId") || function() {
            return ++rb
        };
    ...
    var yb = m("yt.events.events.counter_") || {
        count: 0
    };
    ...
    function S(a, b, c) {
        ...
        if (a = q(a) ? b.getElementById(a) : a)
            if ("iframe" != a.tagName.toLowerCase() && (b = Eb(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (b = a = this.a, b = b[r] || (b[r] = ++ca), a.id = "widget" + b), Q[this.a.id] = this, window.postMessage) {
                this.f = new N;
                Fb(this);
                a = T(this.b, "events");
